      ...
      <div class="container overflow-hidden">
        <div class="row gy-4 gy-lg-0 justify-content-xl-between">
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            <div class="widget">
              <a href="#!">
                <img src="./assets/img/branding/bprw.png" alt="" class="bsb-tpl-logo-footer">
                <img src="./assets/img/branding/lps.png" alt="" class="bsb-tpl-logo-footer">
              </a>
          ...
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            <div class="widget">
              <h4 class="widget-title mb-4">Contact Person</h4>
              <address class="mb-4">Jl. Kemiri no 40 Kec. Kramat Kel. Dampyak Kab. Tegal Jawa Tengah</address>
              <p class="mb-1">
                <a class="link-secondary text-decoration-none" href="tel:+15057922430">0821 01824147</a>
              </p>
              <p class="mb-0">
                <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">bpr@bpr.com</a>
              </p>
            </div>
          </div>
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          ...
          <div class="col-12 col-lg-3 col-xl-4">
            <div class="widget">
              <h4 class="widget-title mb-4">Keluhan lebih lanjut</h4>
              <p class="mb-4">Kirim kan email anda untuk tindakan lebih lanjut</p>
              <form action="#!">
                <div class="row gy-4">
                  <div class="col-12">
        ...
        <div class="row gy-4 gy-md-0">
          <div class="col-xs-12 col-md-7 order-1 order-md-0">
            <div class="copyright text-center text-md-start">
              &copy; 2023. Nur Afif Raihan.
            </div>
            <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
              Built by Me with <span class="text-primary">&#9829;</span>
            </div>
          </div>
