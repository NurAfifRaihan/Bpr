...
?>
<section id="depo" class="wave-bg-sea-shell py-5 py-xl-8 py-xxl-16">
        <div class="container">
            <div class="row gy-5 gy-lg-0 gx-lg-8 align-items-center">
                <div class="col-12 col-lg-5">
                    <h2 class="display-3 fw-bolder mb-4">Deposito </h2>
                    <h3>Keunggulan deposito</h3>
                    <ul>
                    ...
                    <ul>
                        <li>Membawa bukti identitas diri yang masih berlaku, yaitu : <ul>
                            <li>Perorangan : KTP (WNI) KITAS/Passport (WNA)</li>
                            <li>Badan Usaha : SIUP, TDP, NPWP</li></ul>
                        </li>
